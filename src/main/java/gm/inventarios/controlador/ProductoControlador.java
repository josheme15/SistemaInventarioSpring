...
import gm.inventarios.exception.RecursoNoEncontrandoExcepcion;
...
public class ProductoControlador {
    ...
    // localhost8080/inventario-app/productos
    ...
    public ResponseEntity<Producto> obtenerProductoPorId(@PathVariable int id) {
        ...
        if (producto != null) {
            ...
            throw new RecursoNoEncontrandoExcepcion("No se encontró el id: " + id);
        }
    }
    ...
    public ResponseEntity<Producto> actualizarProducto(@PathVariable int id, @RequestBody Producto productoRecibido) {
        Producto producto = this.productoServicio.buscarProductoPorId(id);
        if(producto == null){
            throw new RecursoNoEncontrandoExcepcion("No se encontro el id: " + id);
        }
